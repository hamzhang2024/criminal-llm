...
const LLM_PRESETS = [
  ...
  { key: 'doubao', label: '豆包（火山引擎）', baseUrl: 'https://ark.cn-beijing.volces.com/api/v3', model: 'doubao-seed-1.6-flash', contextK: 256, keyHint: 'Key 在火山引擎控制台（console.volcengine.com/ark）创建；可选 doubao-seed-1.6 / doubao-seed-1.6-flash / doubao-seed-1.6-lite（手动改模型名）' },
            ...
            <div style={{ paddingTop: '16px', borderTop: '1px solid var(--macos-border)' }}>
              ...
              <ul style={{ margin: 0, paddingLeft: '16px', fontSize: '11px', color: '#86868b', lineHeight: '1.8' }}>
                <li>
                  ...
                  （DeepSeek / 千问 / Kimi 均为前缀自动命中，无需配置；豆包为显式缓存，需 Context API 创建缓存，后续版本支持；Ollama 本地无计费概念）
                </li>

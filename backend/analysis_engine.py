...
### 三、类案裁判要旨
- **严禁编造案例！** 只能引用确知存在的指导性案例或公报案例
- 如无法确认具体案号，不要编造案号和案名
- 可引用最高人民法院发布的指导性案例（仅引用编号和标题，如"指导案例XX号"）
- 可概括裁判规则（如"司法实践中，被害人过错可作为酌定从轻情节"），但不要编造具体案件
- 如需精确类案检索，请提示用户使用类案检索功能
    ...
    for i, ev in enumerate(evidence_list):
        ...
        if ev_key_facts:
            ...
            keyfact_mapping = {
                ...
                "fact_behavior": ["殴打", "伤害", "盗窃", "诈骗", "抢劫", "敲诈", "纠集", "分发", "持钢管", "戳击"],
